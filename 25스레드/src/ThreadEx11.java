...
class ThreadT extends Thread {
	...
	@Override
	public void run() {
		//1. 100번 반복해서 0~99까지 result 변수에 누적
...
public class ThreadEx11 {
	public static void main(String[] args) {
		...
		new ThreadT("첫번째 스레드").start(); //작업우선순위 5
		new ThreadT("두번째 스레드").start(); //작업우선순위 5
		new ThreadT("세번째 스레드").start(); //작업우선순위 5
